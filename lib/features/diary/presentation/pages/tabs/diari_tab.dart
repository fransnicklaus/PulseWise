...
class _DiariTabState extends ConsumerState<DiariTab> {
  ...
  Widget build(BuildContext context) {
    ...
    final hasDiaryData = diary != null;
    final hasNetworkError = _isNetworkError(diaryState.errorCause);
    final showOfflinePage =
        hasNetworkError && !hasDiaryData && !isSkeleton && !isRefreshing;
    final showOfflineBanner = hasNetworkError && hasDiaryData;
                                          ...
                                          (entry) => Padding(
                                            ...
                                            child: _SleepEntryItem(
                                              sleepTime: isSkeleton
                                                  ? '22:30'
                                                  : diary!
                                                      .sleeps[entry].sleepTime,
                                              wakeTime: isSkeleton
                                                  ? '06:30'
                                                  : diary!
                                                      .sleeps[entry].wakeTime,
                                              duration: isSkeleton
                                                  ? 8
                                                  : diary!.sleeps[entry]
                                                      .sleepDurationHours,
