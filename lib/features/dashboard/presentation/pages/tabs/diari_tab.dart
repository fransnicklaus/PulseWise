                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          const Icon(Icons.favorite, color: Color(0xFF2D9744)),
                          const SizedBox(width: 8),
                          const Text(
                            'Kodisi',
                            style: TextStyle(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          const Icon(Icons.restaurant, color: Color(0xFF2D9744)),
                          const SizedBox(width: 8),
                          const Text(
                            'Konsumsi Harian',
                            style: TextStyle(
                      ...
                      _MealItem(
                        title: 'Sarapan Pagi',
                        description: 'Nasi goreng, telur mata sapi, teh manis',
                      ),
                      const SizedBox(height: 12),
                      _MealItem(
                        title: 'Makan Siang',
                      ...
                      _MealItem(
                        title: 'Camilan',
                        description: 'Buah apel, biskuit gandum, kopi tanpa gula',
                      ),
                    ],
                  ),
                ),
